...
with st.sidebar:
    ...
    if model_choice == "Logistic Regression":
        ...
        model_params['random_state'] = st.number_input("Random State (Mô hình 1)", value=32, step=1, help="Gạt seed cố định tính ngẫu nhiên.")
        ...
        model_params['random_state'] = st.number_input("Random State (Mô hình 2)", value=32, step=1, help="Seed cố định của mô hình.")
        ...
        model_params['random_state'] = st.number_input("Random State (Mô hình 3)", value=32, step=1, help="Seed ngẫu nhiên cố định từ thiết lập notebook.")
...
# Kiểm tra tính toàn vẹn của cấu trúc cột dữ liệu
